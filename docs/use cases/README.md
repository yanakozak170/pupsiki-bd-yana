...
@startuml
    ...
    |Система|
        :Перевіряє ім'я проєкту на унікальність
...
@startuml
    ...
    |Система|
        ...
        <font color="red">EXC_NoMatchingProject</font>;
    |Система|
        :Відкриває вікно з проектом;
    |Адміністратор|
        :Натискає кнопку налаштування проекту;
    |Система|
    ...
    |Система|
        :Перевіряє, чи не розблокований проєкт
