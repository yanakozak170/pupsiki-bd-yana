...
[Workflow](https://en.wikipedia.org/wiki/Workflow) - впорядкована структура діяльності, яка організовує ресурси в
процеси. Графічно може бути представлена як
...
|:----------------------:|:---------------------------------------------------------------------|
|       **НАЗВА:**       | Block Project                                                        |
|     **УЧАСНИКИ:**      | Користувач (адміністратор), База даних                               |
|    **ПЕРЕДУМОВИ:**     | - Користувач авторизований                                           |
|                        | - Користувач є адміністратором                                       |
|                        | - Проєкт існує і не заблокований                                     |
|     **РЕЗУЛЬТАТ:**     | Проєкт стає заблокованим і недоступним для редагування учасниками    |
| **ВИКЛЮЧНІ СИТУАЦІЇ:** | - Проєкт вже заблокований                                            |
|                        | - Проекту не існує                                                   |
|                        | - Користувач не має прав адміністратора                              |
|                        | - Відміна операції розблокування проєкту                             |
| **ОСНОВНИЙ СЦЕНАРІЙ:** | 1. Адміністратор обирає проєкт.                                      |
|                        | 2. Адміністратор відкриває налаштування проєкту.                     |
|                        | 3. Адміністратор обирає опцію "Заблокувати проєкт".                  |
|                        | 4. Адміністратор підтверджує блокування проєкту.                     |
|                        | 5. Адміністратор заблоковує проєкт та повідомляє про це користувача. |

### Unblock project (SC14)
...
|    **ПЕРЕДУМОВИ:**     | - Користувач авторизований                                            |
|                        | - Користувач є адміністратором                                        |
|                        | - Проєкт існує і заблокований                                         |
|     **РЕЗУЛЬТАТ:**     | Проєкт розблоковується і стає доступним для редагування учасниками    |
| **ВИКЛЮЧНІ СИТУАЦІЇ:** | - Проєкт вже розблокований                                            |
|                        | - Проекту не існує                                                    |
|                        | - Користувач не має прав адміністратора                               |
|                        | - Відміна операції розблокування проєкту                              |
| **ОСНОВНИЙ СЦЕНАРІЙ:** | 1. Адміністратор обирає проєкт.                                       |
|                        | 2. Адміністратор відкриває налаштування проєкту.                      |
|                        | 3. Адміністратор обирає опцію "Розблокувати проєкт".                  |
|                        | 4. Адміністратор підтверджує розблокування проєкту.                   |
|                        | 5. Адміністратор розблоковує проєкт та повідомляє про це користувача. |
...
|    **ПЕРЕДУМОВИ:**     | - Користувач авторизований                                             |
|                        | - Користувач є адміністратором                                         |
|                        | - Користувач, якого потрібно заблокувати, існує у системі              |
|     **РЕЗУЛЬТАТ:**     | Користувач стає заблокованим і втрачає доступ до проєктів              |
| **ВИКЛЮЧНІ СИТУАЦІЇ:** | - Користувач, якого блокують - вже заблокований                        |
|                        | - Користувача не існує у системі                                       |
|                        | - Користувач, що блокує, не має прав адміністратора                    |
|                        | - Відміна операції блокування користувача                              |
| **ОСНОВНИЙ СЦЕНАРІЙ:** | 1. Адміністратор обирає користувача, якого потрібно заблокувати.       |
|                        | 2. Адміністратор відкриває налаштування користувача.                   |
|                        | 3. Адміністратор обирає опцію "Заблокувати користувача".               |
|                        | 4. Адміністратор підтверджує блокування користувача.                   |
|                        | 5. Система заблоковує користувача та повідомляє про це адміністратора. |
...
|    **ПЕРЕДУМОВИ:**     | - Користувач авторизований                                              |
|                        | - Користувач є адміністратором                                          |
|                        | - Користувач, якого потрібно розблокувати, існує у системі              |
|     **РЕЗУЛЬТАТ:**     | Користувач розблоковується і отримує доступ до проєктів                 |
| **ВИКЛЮЧНІ СИТУАЦІЇ:** | - Користувач, якого розблоковують, не заблокований                      |
|                        | - Користувача не існує у системі                                        |
|                        | - Користувач, що розблокує, не має прав адміністратора                  |
|                        | - Відміна операції розблокування користувача                            |
| **ОСНОВНИЙ СЦЕНАРІЙ:** | 1. Адміністратор обирає користувача, якого потрібно розблокувати.       |
|                        | 2. Адміністратор відкриває налаштування користувача.                    |
|                        | 3. Адміністратор обирає опцію "Розблокувати користувача".               |
|                        | 4. Адміністратор підтверджує розблокування користувача.                 |
|                        | 5. Система розблоковує користувача та повідомляє про це адміністратора. |
